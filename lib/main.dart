...
import 'package:navigationdrawer/privacy_policy.dart';
  ...
  Widget MyDrawerList() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          menuItem(1, "Home Page", Icons.home,
              currentPage == DrawerSections.homepage ? true : false),
          menuItem(2, "OverflowBox", Icons.gif_box,
              currentPage == DrawerSections.overflowbox ? true : false),
        ...
        onTap: () {
          ...
          setState(() {
            if (id == 1) {
              ...
              currentPage = DrawerSections.overflowbox;
            } else if (id == 3) {
